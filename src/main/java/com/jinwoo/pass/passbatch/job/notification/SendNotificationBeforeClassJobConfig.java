...
import com.jinwoo.pass.passbatch.repository.notification.NotificationEvent;
import com.jinwoo.pass.passbatch.repository.notification.NotificationModelMapper;
...
public class SendNotificationBeforeClassJobConfig {
    ...
    @Bean
    public Job sendNotificationBeforeClassJob(JobRepository jobRepository, PlatformTransactionManager platformTransactionManager){
        return new JobBuilder("sendNotificationBeforeClassJob", jobRepository)
                .start(addNotificationStep(jobRepository, platformTransactionManager))
                .next(sendNotificationStep(jobRepository, platformTransactionManager))
                .build();
    }

    @Bean
    public Step addNotificationStep(JobRepository jobRepository, PlatformTransactionManager platformTransactionManager){
        return new StepBuilder("addNotificationStep", jobRepository)
                ...
                .processor(addNotificationItenProcessor())
    ...
    @Bean
    public ItemProcessor<BookingEntity, NotificationEntity> addNotificationItenProcessor(){
     ...
     */
    @Bean
    public Step sendNotificationStep(JobRepository jobRepository, PlatformTransactionManager platformTransactionManager){
